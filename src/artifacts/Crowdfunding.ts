...
import CrowdfundingContractArtifactJson from '../../circuits/crowdfunding/target/crowdfunding_contract-Crowdfunding.json' with { type: 'json' };
...
donation_receipts: {
  ...
  public declare methods: {
    ...
    public static get events(): { WithdrawlProcessed: {abiType: AbiType, eventSelector: EventSelector, fieldNames: string[] } } {
    return {
      WithdrawlProcessed: {
        abiType: {
    "kind": "struct",
